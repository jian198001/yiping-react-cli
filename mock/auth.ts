...
const page = (req: Request, res: Response) => {
  res.json({
    ...
    message: '',
    data: [
      { id: '123', username: '刘德华', title: '标题测试1', materialName: '测试物料名称', sku:'测试规格', quantity: 15, consumeTime: null,}, { id: '321', username: '张学友',  title: '标题测试2', materialName: '试验溶剂', sku:'T01', quantity: 5, consumeTime: null,},
    ]
    })
}
