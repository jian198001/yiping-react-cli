export default {
  ...
  'app.settings.basic.avatar': '頭 像',
  'app.settings.basic.change-avatar': '更換頭像',
  'app.settings.basic.email': '郵 箱',
  'app.settings.basic.email-message': '請輸入您的郵箱!',
  'app.settings.basic.nickname': '昵 稱',
  ...
  'app.settings.security.modify': '修 改',
  'app.settings.security.set': '設 置',
  'app.settings.security.bind': '綁 定',
