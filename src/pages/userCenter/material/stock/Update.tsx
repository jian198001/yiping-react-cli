// 从 @ant-design/pro-components 库中导入 ProFormInstance、ModalForm 和 BetaSchemaForm 组件
import {
  ProFormInstance,
  ModalForm,
  BetaSchemaForm,
...
// 从 @/services/userCenter/material/stock 模块中导入 update 和 getById 函数
import { update, getById } from "@/services/userCenter/material/stock";
 ...
 * @param {string} props.id - 要编辑的物料库存的 ID
