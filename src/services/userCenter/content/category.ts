...
export async function update(data: any) {
  const url = "/staff/web/userCenter/content/category/update.json";
...
export async function getById(id: string) {
  const url = "/staff/web/userCenter/content/category/getById.json";
...
export async function del(options?: { [key: string]: any }) {
  const url = "/staff/web/userCenter/content/category/del.json";
